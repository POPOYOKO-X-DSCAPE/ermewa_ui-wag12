...
type FilterEndpoints<
	T extends { endpoints: Record<string, { methods: HttpMethod[] }> },
...
export type ApiMethods<
	...
	A extends ApiConfiguration<T>,
> = {
	[K in Lowercase<
		A["endpoints"][keyof A["endpoints"]]["methods"][number]
	>]: Record<
		FilterEndpoints<A, Uppercase<K>>,
		<R extends Record<string, unknown>>(options?: {
			body?: BodyInit | Record<string, unknown>;
			params?: Record<string, string | number>;
		}) => Promise<{ data: R; setEnv: Store<T>["patch"] }>
	>;
};
